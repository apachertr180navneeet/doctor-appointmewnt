    ...
    <body>
       <div class="layout-wrapper layout-content-navbar">
            <div class="layout-container">
                @include('doctor.layouts.elements.left_sidebar')
                <div class="layout-page">
                    @include('doctor.layouts.elements.header')
                    <div class="content-wrapper">
                        @yield('content')
                        @include('doctor.layouts.elements.footer')
                        <div class="content-backdrop fade"></div>
                    </div>
                    @include('doctor.layouts.elements.right_sidebar')
                </div>
                ...
                @yield('script')
                @include('doctor.layouts.elements.sweet_alerts')
            </div>
