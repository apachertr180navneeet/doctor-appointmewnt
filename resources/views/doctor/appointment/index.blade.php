...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('doctor.appointment.create') }}" class="btn btn-primary">Add Appointment</a>
                            ...
                            <tbody>
                                @foreach ( $appointments as $appointment)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('doctor.appointment.show', $appointment->id) }}" class="btn btn-sm btn-info">View</a>
...
<script>
    $(document).ready(function() {
        ...
        const urls = {
            delete: "{{route('doctor.appointment.delete')}}",
        };
