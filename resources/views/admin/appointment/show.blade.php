        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card mt-2 mb-2">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.appointment.check') }}" method="post" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="card mt-2 mb-2">
                <div class="card-body">
                    <div class="row">
                        <form action="{{ route('admin.appointment.update.time') }}" method="post" enctype="multipart/form-data">
                            @csrf
