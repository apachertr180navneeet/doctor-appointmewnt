                    ...
                    <div class="row footer-widget-wrapper">
                        <div class="col-lg-4 col-md-6 col-sm-6 footer-widget">
                            <div class="footer-widget__logo mb-30">
                                <img src="{{asset('assets/web/assets/images/logo/dark-logo-160x48.webp')}}" width="160" height="48" class="img-fluid" alt="">
                            </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                <li><a href="#" class="image_btn" aria-label="Google play Button"><img class="img-fluid" src="{{asset('assets/web/assets/images/icons/aeroland-button-google-play.webp')}}" alt=""></a></li>
                                <li><a href="#" class="image_btn" aria-label="App Store Button"><img class="img-fluid" src="{{asset('assets/web/assets/images/icons/aeroland-button-app-store.webp')}}" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
